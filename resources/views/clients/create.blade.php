...
<div class="container py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="text-muted mb-0">Заполните информацию о новом клиенте</p>
        </div>
                ...
                <div class="card-body p-4">
                    ...
                    <form action="{{ route('clients.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            @enderror
                            <small class="form-text text-muted">
                                Укажите контактный телефон клиента
                            </small>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            @enderror
                            <small class="form-text text-muted">
                                Дата рождения клиента (необязательно)
                            </small>
                        </div>
