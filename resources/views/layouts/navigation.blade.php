        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link :href="route('expenditures.index')" :active="request()->routeIs('expenditures.index')">
                        Расходы
                    </x-nav-link>
            ...
            <div class="flex items-center space-x-4">
                ...
                @php
                    ...
                    $employeeCount = $currentShift ? $currentShift->employees->count() : 0;
                @endphp

                <!-- Единая кнопка смены - всегда отображается -->
                    ...
                    class="inline-flex items-center px-3 py-2 rounded-lg transition-all duration-200 
                            {{ $status === 'open' 
                                ...
                                : ($status === 'planned' 
                                    ...
                                    : 'bg-gray-50 hover:bg-gray-100 text-gray-700 border border-gray-200 shadow-sm') }}">
                        
                        <!-- Иконка в зависимости от статуса -->
                        @if($status === 'open')
                        <div class="flex items-center space-x-2">
                            <div class="relative">
                                <div class="h-2 w-2 bg-green-500 rounded-full animate-ping absolute"></div>
                                <div class="h-2 w-2 bg-green-500 rounded-full relative"></div>
                            </div>
                        ...
                        @else
                        <!-- Нет смены - показываем кнопку для открытия/создания -->
                        <div class="flex items-center space-x-2">
                            <span class="text-xs font-medium text-gray-600">
                                Открыть
                            </span>
